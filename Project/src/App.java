        ...
        for (int i = 1; i < 7-1; i++) {
            for (int j = 1; j < 7-1; j++) {
                ...
                //kalo jumlah kotak "ya" di sekitar angka X == angkaX, kotak lainnya diisi "tidak"
                    ...
                    if(minesweeperCheck[i+1][j].equals("iya")&&i+1!=6){
                        hitungIya++;
                    }else if(minesweeperCheck[i+1][j].equals("tidak")&&i+1!=6){
                        hitungTidak++;
                    }
                    ...
                    if(minesweeperCheck[i][j+1].equals("iya")&&j+1!=6){
                        hitungIya++;
                    }else if(minesweeperCheck[i][j+1].equals("tidak")&&j+1!=6){
                        hitungTidak++;
                    }
                    ...
                    if(minesweeperCheck[i+1][j+1].equals("iya")&&i+1!=6&&j+1!=6){
                        hitungIya++;
                    }else if(minesweeperCheck[i+1][j+1].equals("tidak")&&i+1!=6&&j+1!=6){
                        hitungTidak++;
                    }
                    if(minesweeperCheck[i+1][j-1].equals("iya")&&i+1!=6&&j-1!=0){
                        hitungIya++;
                    }else if(minesweeperCheck[i+1][j-1].equals("tidak")&&i+1!=6&&j-1!=0){
                        hitungTidak++;
                    }
                    if(minesweeperCheck[i-1][j+1].equals("iya")&&i-1!=0&&j+1!=6){
                        hitungIya++;
                    }else if(minesweeperCheck[i-1][j+1].equals("tidak")&&i-1!=0&&j+1!=6){
                        hitungTidak++;
                    }
...
//                    System.out.println(hitungKotak);
                    if(minesweeperBoard[i][j]==hitungIya){
                        ...
                        if(minesweeperCheck[i+1][j].equals("bisajadi")&&i+1!=6){
                            minesweeperCheck[i+1][j]="tidak";
                        }
                        if(minesweeperCheck[i-1][j].equals("bisajadi")&&i-1!=0){
                            minesweeperCheck[i-1][j]="tidak";
                        }
                        if(minesweeperCheck[i][j+1].equals("bisajadi")&&j+1!=6){
                            minesweeperCheck[i][j+1]="tidak";
                        }
                        if(minesweeperCheck[i][j-1].equals("bisajadi")&&j-1!=0){
                            minesweeperCheck[i][j-1]="tidak";
                        }
                        if(minesweeperCheck[i+1][j+1].equals("bisajadi")&&i+1!=6&&j+1!=6){
                            minesweeperCheck[i+1][j+1]="tidak";
                        }
                        if(minesweeperCheck[i+1][j-1].equals("bisajadi")&&i+1!=6&&j-1!=0){
                            minesweeperCheck[i+1][j-1]="tidak";
                        }
                        if(minesweeperCheck[i-1][j+1].equals("bisajadi")&&i-1!=0&&j+1!=6){
                            minesweeperCheck[i-1][j+1]="tidak";
                        }
